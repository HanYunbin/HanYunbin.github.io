...
const ITEM_DATABASE = [
  ...
  { id: 'item_2', name: '나무 방패', type: 'armor', value: 15, stats: { health: 5 }, description: '간단한 나무 방패.' },
  // 의상실 (Tailor) 아이템
  { id: 'item_3', name: '초보자 로브', type: 'armor', value: 20, stats: { intelligence: 3 }, description: '마법 초보자를 위한 로브.', shopCategory: 'tailor' },
  { id: 'item_8', name: '가죽 갑옷', type: 'armor', value: 40, stats: { health: 15, strength: 2 }, description: '가볍고 튼튼한 가죽 갑옷.' },
...
const calculateDerivedStats = (character) => {
  ...
  const maxMana = (intelligence * 5) + (level * 5); // maxMana는 사용되지 않으므로 고정값으로 반환
